...
// CAROSSEL ----------------------------------------------------
let indiceAtual = 0;
const depoimentos = document.querySelectorAll('.resumo-depoimento');
...
const observer = new IntersectionObserver(entries => {
    ...
    {
        threshold: 0.3 // 60% da seção visível já conta como "ativa"
    }
);
...
const themeSystem = localStorage.getItem('themeSystem') || (localStorage.setItem('themeSystem', 'dark'), 'dark');
...
function defineCurrentTheme(theme){
    ...
    if (theme == "light"){
        btnTema.innerHTML = darkSvg;
    } else {
        btnTema.innerHTML = lightSvg;
    }
